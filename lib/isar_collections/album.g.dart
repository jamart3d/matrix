...
extension AlbumByIndex on IsarCollection<Album> {
  Future<Album?> getByTitle(String title) {
    return getByIndex(r'title', [title]);
  }

  Album? getByTitleSync(String title) {
  ...
  Future<List<Album?>> getAllByTitle(List<String> titleValues) {
    final values = titleValues.map((e) => [e]).toList();
    return getAllByIndex(r'title', values);
  }

  List<Album?> getAllByTitleSync(List<String> titleValues) {
    final values = titleValues.map((e) => [e]).toList();
  ...
  Future<Id> putByTitle(Album object) {
    return putByIndex(r'title', object);
  }

  Id putByTitleSync(Album object, {bool saveLinks = true}) {
    return putByIndexSync(r'title', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByTitle(List<Album> objects) {
    return putAllByIndex(r'title', objects);
  }

  List<Id> putAllByTitleSync(List<Album> objects, {bool saveLinks = true}) {
...
extension AlbumQueryWhereSort on QueryBuilder<Album, Album, QWhere> {
  ...
  QueryBuilder<Album, Album, QAfterWhere> anyTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension AlbumQueryWhere on QueryBuilder<Album, Album, QWhereClause> {
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleEqualTo(String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleNotEqualTo(String title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleGreaterThan(
    String title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleLessThan(
    String title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleBetween(
    String lowerTitle,
    String upperTitle, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleStartsWith(
      String TitlePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'title',
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<Album, Album, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension AlbumQueryFilter on QueryBuilder<Album, Album, QFilterCondition> {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> dateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'date',
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> dateGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> dateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> dateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> imageUrlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'imageUrl',
      ));
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> imageUrlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'imageUrl',
      ));
...
extension AlbumQueryLinks on QueryBuilder<Album, Album, QFilterCondition> {
  QueryBuilder<Album, Album, QAfterFilterCondition> songs(FilterQuery<Song> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'songs');
    });
  }

  QueryBuilder<Album, Album, QAfterFilterCondition> songsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> songsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'songs', 0, true, 0, true);
    });
  }

  QueryBuilder<Album, Album, QAfterFilterCondition> songsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'songs', 0, false, 999999, true);
    });
  }

  QueryBuilder<Album, Album, QAfterFilterCondition> songsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> songsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> songsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AlbumQuerySortBy on QueryBuilder<Album, Album, QSortBy> {
  ...
  QueryBuilder<Album, Album, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AlbumQuerySortThenBy on QueryBuilder<Album, Album, QSortThenBy> {
  ...
  QueryBuilder<Album, Album, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
...
extension AlbumQueryProperty on QueryBuilder<Album, Album, QQueryProperty> {
  ...
  QueryBuilder<Album, DateTime?, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
